...
unsigned int Function2::GetOutputSize() const { return A0.rows(); }

unsigned int Function2::GetX0Size() const { return A0.cols(); }

unsigned int Function2::GetW0Size() const { return B0.cols(); }
...
Function2 Function2::Empty(unsigned int xSize, unsigned int wSize) {
